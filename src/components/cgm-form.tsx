...
import CGMSchema from "@/schemas/cgm"
...
export default function CGMForm() {
  ...
  function onSubmit(data: z.infer<typeof CGMSchema>) {
    toast({
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="bg-white bg-opacity-40 px-8 py-10 rounded space-y-4 text-white w-2/3">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="space-y-3">
              <FormLabel>Who is submitting this form? *</FormLabel>
              <FormControl>
                <RadioGroup
                ...
                >
                  ...
                  <FormItem className="flex items-center space-x-3 space-y-0">
                    <FormControl>
                      <RadioGroupItem value="Patient Navigator" />
                    </FormControl>
                    <FormLabel className="font-normal">
                      Patient Navigator
                    </FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="prescription">Do you need a CGM? Upload prescription here.</FormLabel>
              <FormControl>
                <Input id="prescription" type="file" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
